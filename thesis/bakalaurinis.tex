...
\cite{298007} \cite{857823} \cite{857823} \cite{1007668}
...
Be to, daugiasluoksniai perceptronai yra organizuojami sluoksniais.
...
Signalo skaičiavimo atliekamas operacijas, nurodytas \ref{a} formulėje, galima sutraukti į matricų daugybos operacijas, o aktyvacijos funkciją pritaikyti visai matricai.
...
\subsection{Neuroninio tinklo apmokymas}

\TODO{parašyti}

\section{Duomenys}

\subsubsection{Momento koeficientas}
...
Momento koeficiento metodas veikia panašiai, tačiau šiek tiek praplečia svorių keitimą.
...
Kiekvienam parametrui išsaugomas kitimo greitis, kuris po kiekvienos apmokymo iteracijos pakeičiamas padidinant ar pamažinant tam tikra reikšme pagal tai, kaip šioje iteracijoje reikia keisti parametro dydį.
...
\includegraphics[scale=0.40]{pics/dimensionality_reduction_progress}
\includegraphics[scale=0.40]{pics/dimensionality_reduction_result}
