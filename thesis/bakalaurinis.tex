...
\cite{298007} \cite[289~psl.]{price-dimensionality-reduction}
...
\TODO{įdėti ref į straipsnį apie SLP lėtą mokymąsi sunkioms užduotims - iš dėstytojo}
...
\begin{enumerate}
	...
	\item Tiriamų chromosomų duomenų dimensiškumas sumažintas iki visų galimų dimensijų skaičių, ištirta dimensiškumo mažinimo įtaka duomenims juos bandant atstatyti į pradinius,
	...
	\item Palyginta, kaip keičiasi klasifikavimo rezultatai duomenų dimensiškumą sumažinus iki pasirinkto optimalaus skaičiaus lyginant su nemažinto dimensiškumo duomenimis,
\end{enumerate}
...
Dimensiškumo mažinimas iki kažkiek dimensijų nelabai daug pakenkia - iš grafiko matosi, kad dekompresuoti pavyksta gan tiksliai.
