...
\raktiniaizodziai{diagiasluoksnis perceptronas, dimensiškumo mažinimas, bruožų išskyrimas, klasifikacija, daugiamačiai duomenys}
...
Vieni populiariausi dimensiškumo mažinimo būdai, aprašomi \cite{feature-extraction} knygoje - bruožų parinkimas (angl.~\textit{feature selection}) bei bruožų išskyrimas (angl.~\textit{feature extraction}).
