...
Taip atsitinka dėl neuroninio tinklo veikimo principo - parametrai, kurių reikmės linkusios būti didesnėmis, turėtų didesnę įtaką rezultatui nei parametrai su mažesnėmis reikšmėmis, kadangi pradiniai duomenų signalai būtų daug stipresni parametrų su didesnėmis reikšmėmis.
Tačiau daug naudingiau būtų visiems parametrams suteiktu vienodą svarbą, kadangi parametro reikšmių intervalas neturi nieko bendro su parametro svarba - gali būti ir taip, kad dideles reikšmes įgyjantis parametras yra kur kas mažiau svarbus nei mažas reikšmes įgyjantysis.
...
\begin{enumerate}
	...
	\item\url{http://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=1007668&tag=1}
\end{enumerate}
